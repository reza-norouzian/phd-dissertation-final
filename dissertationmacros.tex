...
% D-009 (23 September 2026): the questions follow the chapter order. RQ1 and RQ2 are
% the Android questions; RQ3 with RQ3.1 and RQ3.2 is the former RQ1 with RQ1.1 and RQ1.2.
...
\newcommand{\rqThreeText}{How can behaviour in networked and industrial systems be
  represented to support anomaly detection?}
\newcommand{\rqThreeOneText}{How can service relationships be represented as
  communication graphs to identify unexpected interactions?}
\newcommand{\rqThreeTwoText}{How can a modular learning framework analyse network and
