...
and link-prediction benchmarks over pairwise graphs. In those experiments, none of the
unmodified GAT-based models outperformed all non-attentive baselines \cite{fang2025kaa}.
Their ranking analysis also concerns pairwise attention at bounded model capacity. These
