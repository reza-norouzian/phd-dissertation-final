...
rule uses a historical context and may merge adjacent anomalous intervals. The recorded test
labels provide the reference for the reported performance metrics. The historical context used
by the threshold is a separate
