...
unrounded values:
\begin{alignat*}{3}
  \mathrm{Precision} &= TP/(TP+FP)          &&= 47{,}279/64{,}670   &&= 73.11\%,\\
  \mathrm{Recall}    &= TP/(TP+FN)          &&= 47{,}279/51{,}453   &&= 91.89\%,\\
  F_1                &= 2TP/(2TP+FP+FN)     &&= 94{,}558/116{,}123  &&= 81.43\%,\\
  \mathrm{FPR}       &= FP/(FP+TN)          &&= 17{,}391/342{,}226  &&= 5.08\%,\\
  \mathrm{Accuracy}  &= (TP+TN)/(TP+FN+FP+TN) &&= 372{,}114/393{,}679 &&= 94.52\%.
\end{alignat*}
