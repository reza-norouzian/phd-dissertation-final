...
{\nadics{} receives tabular records. Its network path takes connection features derived from S7comm, PROFINET, 
...
method. RQ3.1 is answered here at the level of representation, update procedure, and measured
overhead.
