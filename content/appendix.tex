...
Figure~\ref{fig:anomaly:iuno-importance} exactly: the first ten fields hold 54.47\% of the
total, the first 24 hold 80.72\% and the first 36 hold 90.41\%. The remaining 27
fields share 9.59\%. Fields of equal importance keep the order of the source record, and
...
\newcommand{\nadicsGroupsCaption}{Importance by field group. Both shares are given in \% of the
