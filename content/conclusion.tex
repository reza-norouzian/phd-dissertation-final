...
\paragraph{RQ3.} \emph{\rqThreeText} Communication graphs represent service relationships,
while protocol records and process windows support industrial anomaly detection.
Chapter~\ref{chap:anomaly} addresses gap~\gapref{3} through these implementations.

\paragraph{RQ3.1.} \emph{\rqThreeOneText} A node-local graph stores relations observed during
service start-up. Unexpected relations trigger an alert and can be approved by the site owner
as the deployment changes.

\paragraph{RQ3.2.} \emph{\rqThreeTwoText} \nadics{} separates feature preparation from
