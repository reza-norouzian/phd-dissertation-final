...
The GAN-based extension with 24 PCA components achieved 91.89 per cent timestamp recall at a
false-positive rate of 5.08 per cent on later SWaT test data. These separate evaluations address
